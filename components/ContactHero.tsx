...
const ContactHero = () => {
  const contactMethods = [
    ...
    { icon: Clock, label: "Hours", value: "9 AM - 9 PM Daily", href: null },
    {
      icon: Mail,
      label: "Email",
      value: "info@zamantyre.com",
      href: "mailto:info@zamantyre.com",
    },
  ];
    ...
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container-max text-center text-white px-4">
        ...
        >
          ...
          >
            Ready to get your tires serviced? Contact us today for expert
            advice, service appointments, or any questions about our tire
