  ...
  const services = [
    {
      ...
      description: 'Expert tire installation service for both new and used tires. Our certified technicians ensure proper mounting, balancing, and inflation for optimal performance and safety.',
      features: [
    ...
    },
    {
      ...
      description: 'Advanced computerized wheel balancing service to eliminate vibrations and ensure smooth, comfortable driving. Our precision equipment provides accurate balancing for all wheel types.',
      features: [
    ...
    },
    {
      ...
      description: 'State-of-the-art 3D wheel alignment service using the latest technology to ensure precise alignment angles. Perfect for optimal vehicle performance, safety, and tire longevity.',
      features: [
    ...
    },
    {
      ...
      description: 'Premium nitrogen air service for superior tire performance. Nitrogen provides more stable tire pressure, better fuel efficiency, and extended tire life compared to regular air.',
      features: [
    ...
    },
    {
      ...
      description: 'Complete engine oil change service with premium quality oils and filters. Regular oil changes are essential for maintaining engine performance and longevity.',
      features: [
    ...
    },
    {
      ...
      description: 'Comprehensive rim and wheel services including sales, installation, and customization. We offer a wide selection of premium rims to enhance your vehicle\'s appearance and performance.',
      features: [
      ...
      <div className="container-max">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Comprehensive automotive services designed to keep your vehicle running smoothly, 
            safely, and efficiently. Each service is performed by certified professionals using premium equipment.
          </p>
        </motion.div>
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 p-8">
                  ...
                  <div className="lg:col-span-1">
                    ...
                    <p className="text-primary-600 font-semibold mb-4">{service.subtitle}</p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-700"><strong>Price:</strong> {service.priceRange}</span>
                      </div>
                      <div className="flex items-center space-x-3">
                        <Shield className="h-5 w-5 text-primary-600" />
                        <span className="text-gray-700"><strong>Warranty:</strong> {service.warranty}</span>
                      </div>
                    </div>
                  </div>
                      ...
                      <div>
                        ...
                        <ul className="space-y-2">
                          {service.features.map((feature, featureIndex) => (
                            <li key={featureIndex} className="flex items-start space-x-2 text-gray-600">
                    ...
                    <div className="mt-8">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {service.process.map((step, stepIndex) => (
                          <div key={stepIndex} className="bg-gray-50 rounded-lg p-3 text-center">
