      ...
      <div className="container-max">
        ...
        >
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
            ...
            have to say about their experience with Zaman tyre Trader.
          </p>
          ...
          <div className="flex items-center justify-center space-x-2 mt-6">
            ...
            <span className="text-2xl font-bold text-gray-300">4.0</span>
            <span className="text-gray-500">(62 reviews)</span>
          </div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-gray-900 rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow duration-300 relative"
            >
              {/* Quote Icon */}
        ...
        >
          <div className="bg-gray-900 rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
              Read all 62+ reviews from our satisfied customers on Google and
              see why we're the most trusted tire shop in Wah Cantt.
            </p>
            ...
            <div className="flex items-center justify-center space-x-4 mb-8">
              ...
              <div className="text-left">
                <div className="text-3xl font-bold text-gray-300">4.0</div>
