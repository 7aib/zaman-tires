      ...
      <div className="container-max">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Real reviews from our satisfied customers. Read what people are saying about 
            their experience with Zaman Tyres Trader.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {reviews.map((review, index) => (
            ...
            >
              ...
              {/* Service Tag */}
              <div className="mb-4">
                <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold ${getServiceColor(review.service)}`}>
                  {review.service}
                </span>
              </div>
        ...
        >
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Read all our reviews on Google and see why customers trust us with their tire needs. 
              Join hundreds of satisfied customers who have rated us 4.0 stars.
            </p>
        ...
        >
          <div className="bg-primary-600 rounded-2xl p-8 md:p-12 text-white">
            ...
            <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
              ...
              our services and helps other customers make informed decisions.
            </p>
